    ...
    <div className="bg-slate-950 text-white min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-green-400">How it Works</p>
            ...
            <div className="space-y-4">
              {SOURCE_FEED.map((item) => (
                <div key={item.source} className="bg-slate-900/70 border border-white/5 rounded-xl p-4">
                  <p className="text-xs uppercase tracking-[0.4em] text-green-400 mb-1">{item.source}</p>
